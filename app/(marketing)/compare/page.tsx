...
export const metadata: Metadata = {
  title: 'Compare — Momenties vs. the alternatives',
  description: 'Honest, side-by-side comparisons between Momenties and Google Calendar, Calendly, Notion Calendar, and Superhuman.',
  alternates: { canonical: '/compare' },
  openGraph: {
    title: 'Compare Momenties',
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Momenties vs. <em className="not-italic text-gold">the alternatives</em>.
          </>
        }
      ...
      <CTA
        ...
        subtitle="Read the full comparison, then try Momenties free for as long as you like."
