...
const SECTIONS: Section[] = [
  {
    ...
    links: [
      ...
      { href: '/data', label: 'Your data', note: 'Portability & deletion' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/developers', label: 'Developers', note: 'API, SDKs, webhooks' },
      { href: '/cli', label: 'CLI', note: 'Terminal interface' },
      { href: '/api-docs', label: 'API docs' },
      { href: '/newsletter', label: 'Newsletter', note: 'The Quiet Hours' },
