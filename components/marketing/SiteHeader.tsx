...
const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Daily Brief', href: '/daily-brief', desc: 'Your AI morning summary' },
      ...
      { label: 'Mobile waitlist', href: '/waitlist', desc: 'Join the early access queue' },
      { label: 'Pro', href: '/pro', desc: 'Everything in the Pro plan' },
      ...
      { label: 'Scheduling links', href: '/schedule', desc: 'Share availability, skip back-and-forth' },
