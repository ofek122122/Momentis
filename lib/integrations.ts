...
export const INTEGRATIONS: Integration[] = [
  {
    ...
    description:
      'Momenties is built on top of Google Calendar. Every event you create in Momenties syncs instantly to Google; every event you create in Google appears in Momenties within seconds. Same source of truth, two interfaces.',
    status: 'live',
    letter: 'G',
    color: '#4285F4',
    keyFeatures: [
      ...
      { title: 'Respects permissions', desc: 'Read-only calendars stay read-only in Momenties. You can\'t accidentally modify a shared schedule.' },
    ],
    howItWorks: [
      'Click Connect Google Calendar in Settings → Integrations.',
      'Sign in with Google and grant calendar permissions.',
      'Momenties lists all your calendars — pick which ones to sync.',
    ...
    faqs: [
      { q: 'How fast is the sync?', a: 'Momenties→Google is instant (<1s). Google→Momenties uses a webhook + fallback poll; expect <5s typical.' },
  ...
  },
  {
    ...
    description:
      'Momenties speaks CalDAV, the open protocol iCloud uses. You generate an app-specific password, enter it once, and every iCloud calendar appears in your unified Momenties view.',
    status: 'live',
    letter: 'A',
    color: '#8E8E93',
    keyFeatures: [
      { title: 'Full two-way CalDAV sync', desc: 'Create in Momenties, appears on your iPhone. Create on your iPhone, appears in Momenties.' },
    ...
    howItWorks: [
      'Go to appleid.apple.com and generate an app-specific password named "Momenties."',
      'In Momenties, Settings → Integrations → Connect Apple Calendar.',
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I migrate from Outlook to Momenties?', a: 'Momenties doesn\'t replace Outlook — it adds to it. Outlook continues to own your mail; Momenties becomes a richer calendar view.' },
    ],
  },
  {
    slug: 'slack',
    name: 'Slack',
    category: 'Messaging',
    tagline: 'Daily briefing in-channel. Mention @momenties to schedule.',
    description:
      'The Momenties Slack app brings scheduling into the conversation. Type /schedule in any channel to create an event. Receive your daily briefing in a DM each morning. Let others book time with /momenties book @you.',
    status: 'live',
    letter: 'S',
    color: '#4A154B',
    keyFeatures: [
    ...
    howItWorks: [
      'Install the Momenties Slack app from your workspace\'s app directory.',
      'Connect your Momenties account on first use (OAuth inside Slack).',
    ...
    permissions: [
      ...
      'Read user identity (to map Slack IDs to Momenties accounts).',
    ],
    faqs: [
      { q: 'Does the Slack bot see all my messages?', a: 'No. It only receives messages that explicitly mention @momenties or use a / slash command.' },
  ...
  },
  {
    ...
    description:
      'Momenties and Notion integrate two ways: embed your Momenties calendar inside any Notion page, and auto-link Notion meeting notes to their corresponding calendar events.',
    status: 'live',
    letter: 'N',
    color: '#E8E8E8',
    keyFeatures: [
      { title: 'Embed blocks', desc: 'Paste a Momenties URL into Notion, get an interactive calendar embed.' },
      ...
      { title: 'Database sync', desc: 'Sync a Notion calendar database both ways with a specific Momenties calendar.' },
    ...
    howItWorks: [
      ...
      'Authorize Momenties to access specific Notion pages (not the whole workspace).',
      'Paste Momenties URLs into Notion to embed; events now offer a "Attach Notion page" option.',
    ],
    permissions: [
    ...
    faqs: [
      { q: 'Can I use this without a Notion account?', a: 'Yes. The integration is optional. Momenties works on its own.' },
