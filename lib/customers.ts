...
export const CUSTOMER_STORIES: CustomerStory[] = [
  {
    ...
    solution:
      'A 50-engineer pilot of Calendro Team, run over two weeks. No training session — engineers installed, connected their Google accounts, and started. Feedback was gathered async via a shared Slack channel. The pilot found two parsing bugs (both fixed within a week) and zero blockers.',
    impact:
      'Four weeks after the pilot, Kindrid rolled out company-wide over a weekend. Within three months, aggregate meeting hours dropped 27% — not because of Calendro alone, but because its meeting cost indicator made teams confront their own calendar behavior. The procurement review, which historically took 3 months for new SaaS tools, finished in 48 hours.',
    body: [
      'Kindrid Health is a Boston-based digital health company serving 1,200 clinical and technical employees. Before Calendro, their scheduling stack was a patchwork.',
      ...
      'The pilot was simple: 50 engineers got Calendro Team for two weeks. They were asked to use it instead of the existing stack, not alongside. Feedback ran async.',
  ...
  },
  {
    ...
    body: [
      ...
      'Before Calendro, Yuki Tanaka (one of the three founding partners) described their calendar situation as "a running apology." Things got missed. Not because people forgot — because typing a new event on a phone, in the middle of a site visit, simply wasn\'t happening.',
      'Calendro replaced that friction with a voice-first mode. Partners now dictate their weeks on walking commutes. Designers capture client visits with voice right after they happen. The studio manager uses photo input for printed briefs and quarterly exhibition schedules.',
      '"We don\'t schedule anymore," Yuki says. "We talk, and it happens. The tool gets out of the way."',
      'Quiet UI helped adoption too. Lanternwork is a design studio — their bar for interface aesthetics is unforgiving. Calendro\'s dark-first, Playfair-headed aesthetic was the first productivity tool they adopted wholesale without grumbling.',
    ],
  },
  {
    slug: 'meridian-vc',
    ...
    impact:
      'Zero missed school events in a full academic year (a personal first). His EA recovered an estimated 6 hours per month. On the work side, Daniel\'s recurring-meeting audit (prompted by the Calendro analytics dashboard) trimmed 4 hours per week of low-value standing invites.',
    body: [
      ...
      'The side effect: Daniel became his firm\'s most vocal internal advocate for Calendro. Meridian now runs on Calendro Team at the partner level; a full-firm rollout is under discussion.',
