...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    excerpt: 'Sync two Google accounts plus one Apple account in one Calendro view.',
    readingMinutes: 3,
    updated: '2026-03-11',
    body: [
      { type: 'p', content: 'Calendro is designed around the reality that most people have more than one calendar account — a work Google Workspace, a personal Gmail, an iCloud with family events, maybe a third Outlook for a side project. We merge them all into one view.' },
      ...
      { type: 'callout', content: 'Events created in Calendro get written back to the default calendar you pick per account. You can change the default in Settings → Calendars at any time.' },
      { type: 'h2', content: 'Privacy between accounts' },
      { type: 'p', content: 'Work and personal accounts don\'t share data in Calendro any more than they do natively. Nothing crosses over unless you explicitly create shared calendars.' },
    ],
    related: [
      { categorySlug: 'calendar-sync', slug: 'connecting-apple-calendar', title: 'Connecting Apple Calendar (CalDAV)' },
      { categorySlug: 'getting-started', slug: 'connecting-google-calendar', title: 'Connecting Google Calendar' },
  ...
  },
  {
    ...
    updated: '2026-04-05',
    body: [
      { type: 'p', content: 'Timezone bugs are calendar software\'s most common failure mode. Calendro gets it right 97% of the time, but when it misbehaves, here\'s how to diagnose it in order.' },
      { type: 'h2', content: '1. Check your display timezone' },
      { type: 'p', content: 'Calendro shows all events in your active display timezone — by default, your device\'s current timezone. If you\'re traveling and forgot to switch your laptop, events may appear at surprising times.' },
      { type: 'ul', content: [
      ...
      { type: 'callout', content: 'Apple CalDAV sometimes misreports TZID for events imported long ago from older clients. If a single event is off and others are fine, this is usually why. Delete and re-create in Calendro; the new version will be correct.' },
    ],
  },
  {
    ...
    updated: '2026-03-27',
    body: [
      { type: 'p', content: 'Calendro offers free Pro plans for students and 50% off for registered non-profits. Both are handled by the same small team; we try to approve within 48 hours.' },
      { type: 'h2', content: 'Students' },
      { type: 'ul', content: [
        'Sign up with any .edu email (or equivalent academic domain) — we auto-detect about 4,000 institutions.',
        'If your school isn\'t auto-detected, email edu@calendro.app with your student ID.',
      ...
      { type: 'ul', content: [
        'Email nonprofit@calendro.app from a domain-verified email.',
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'callout', content: 'Before anything commits, Calendro shows you every extracted event as a preview. You can drop individual ones, merge duplicates, or re-try with a different crop.' },
      { type: 'h2', content: 'Multiple photos at once' },
      { type: 'p', content: 'You can drag up to 10 photos into the input bar. Calendro processes them in parallel and merges the results into a single review list.' },
    ],
    related: [
      { categorySlug: 'ai-features', slug: 'how-the-parser-understands-you', title: 'How the parser understands you' },
    ],
