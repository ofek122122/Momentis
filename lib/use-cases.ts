...
export const USE_CASES: UseCase[] = [
  {
    ...
    oneLiner: 'Momenties helps founders spend fewer hours in meetings and more hours making the thing.',
    quote:
    ...
    solution:
      'Momenties condenses four or five scheduling tools into one surface, replaces form-filling with sentence-typing, and exposes the aggregate cost of recurring meetings so founders can audit their own calendar honestly.',
    workflow: [
    ...
    features: [
      ...
      { title: 'Focus-window protection', desc: 'Momenties blocks deep-work time and warns you before you book over it.' },
    ],
    faqs: [
      { q: 'Does Momenties work with Y Combinator\'s calendar?', a: 'Yes. Momenties syncs to any Google Workspace or Gmail account, including YC\'s.' },
      { q: 'Is there a startup discount?', a: 'Yes — 10 seats of Momenties Team free for 12 months for seed-stage companies. See /startups.' },
      { q: 'Can I use it with Superhuman?', a: 'Yes. Superhuman owns your email; Momenties owns your calendar. Many of our users run both.' },
    ],
    metrics: [
  ...
  },
  {
    ...
    oneLiner: 'Momenties takes a photo of your syllabus and turns it into a fully-populated semester calendar.',
    quote:
    ...
    solution:
      'Momenties\'s Gemini Vision parsing reads every syllabus, exam schedule, and handout in one tap — typically turning 40+ events into a fully-populated semester in under three minutes.',
    workflow: [
      { step: 'Week 1 of semester', detail: 'Snap each syllabus. Review the 40-ish events Momenties extracts. Confirm.' },
    ...
    faqs: [
      { q: 'Does my school count as accredited?', a: 'Momenties auto-detects about 4,000 academic domains. If yours isn\'t in the list, email edu@momenties.app.' },
  ...
  },
  {
    ...
    oneLiner: 'Momenties unifies every client calendar into one color-coded view — and keeps work and life visibly distinct.',
    quote:
      'Three client calendars, one personal, plus my partner\'s shared view. Momenties merges them without turning into a rainbow crayon box.',
    ...
    solution:
      'Momenties syncs unlimited calendars across Google, Apple, and Outlook, auto-colors events by source, and offers client-safe scheduling links that hide other clients\' events.',
    workflow: [
      { step: 'Onboarding a client', detail: 'Connect their Google or Apple calendar. Color code assigned automatically.' },
      { step: 'Scheduling', detail: 'Type "call with rita tuesday" — Momenties picks the right calendar based on the contact.' },
  ...
  },
  {
    ...
    oneLiner: 'Momenties gives managers the visibility — and the honest numbers — to protect their team\'s deep work.',
    quote:
      'Our engineering team saw a 35% drop in meeting hours in the first quarter with Momenties. I did nothing but install it.',
    ...
    solution:
      'Momenties\'s team analytics show aggregate meeting load per person, focus-window protection, and the cost of recurring invites — in a dashboard that respects privacy by default.',
    workflow: [
    ...
    faqs: [
      ...
      { q: 'What plan do I need?', a: 'Momenties Team ($12/user/mo) or Enterprise. Both include full team analytics.' },
  ...
  },
  {
    ...
    oneLiner: 'Momenties reads the school calendar from a PDF or printout and keeps the whole family in sync without a fridge magnet.',
    quote:
      'I used to have the whole school calendar on a magnet on the fridge. Now it\'s on my phone. Momenties read the PDF and did it.',
    ...
    workflow: [
      { step: 'Start of term', detail: 'Snap each school calendar. Confirm the 40-ish events Momenties extracts.' },
    ...
    faqs: [
      ...
      { q: 'What if my partner uses Apple Calendar and I use Google?', a: 'Momenties merges both. You each keep your native tool; the shared layer just works.' },
  ...
  },
  {
    ...
    oneLiner: 'Momenties brings on-call schedules, shift swaps, and meetings into one app that\'s built for clinical realities.',
    quote:
      'Our residency program uses Momenties for shift swaps. The on-call schedule is now a photo, not a spreadsheet. Our chief resident sleeps better because of it.',
    ...
    solution:
      'Momenties\'s photo parsing reads on-call boards, shift-swap requests get proper UI (with conflict detection), and the HIPAA BAA lets institutions roll it out safely.',
    workflow: [
      { step: 'Start of rotation', detail: 'Snap the on-call board. Every shift for the month lands on your calendar.' },
      { step: 'Shift swap', detail: 'Request a swap in two taps. Momenties detects conflicts automatically.' },
    ...
    faqs: [
      { q: 'Is Momenties HIPAA compliant?', a: 'Yes, on the Enterprise tier with a signed BAA. See /security and /enterprise.' },
      { q: 'Can shift swaps require approval?', a: 'Yes. Enterprise admins can configure approval workflows per program.' },
      { q: 'Does it work with Epic, Cerner, or other EHR systems?', a: 'Momenties does not integrate directly with EHRs for clinical reasons. Institutions export schedules; Momenties imports them.' },
    ],
    metrics: [
